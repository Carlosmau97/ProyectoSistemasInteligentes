class Node {
  constructor (value, up, down, left, right) {
    this.value = value
    this.up = up          // Estas deberian ser punteros
    this.down = down      // Estas deberian ser punteros
    this.left = left      // Estas deberian ser punteros
    this.right = right    // Estas deberian ser punteros
  }
}
...
class Tree {
  ...
  add (value, up, down, left, right) {
    // arbol no tiene elementos
    if (this.isEmpty()) {
      this.root = new Node(value, up, down, left, right) // Y aqui mandarle con cual tiene coneccion
      return
    }
